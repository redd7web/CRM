         ...
         foreach ($ikg_info->scheduled_routes as $ekc ){  
            ...
            $html .= "<tr>";
                ...
                $html .= "</td>";
                 ...
                 $bh = $db->query("SELECT fieldreport FROM iwp_data_table WHERE route_id=$ikg_info->route_id AND schedule_id=$sched_ro->schedule_id AND account_no = $sched_ro->account_number");
