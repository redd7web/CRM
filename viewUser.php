<?php include "protected/global.php"; $page = "Management | View User"; if(isset($_SESSION['id'])){  
...
<option value="WY" <?php if($edit_person->state == "WY"){ echo "selected";} ?>>Wyoming</option></select>
    ...
    if($person->isAdmin()){
        ?>
         <div class="field">
            <label for="division_restriction">Password</label>&nbsp;
        </div>
        <div class="field">
            <input type="password" id="password" name="division_restriction"  placeholder="New Password"  value="<?php echo $edit_person->password; ?>"/>
        </div>
    ...
    <div class="field" style="height: auto;text-align:left;">
        <table style="width: 100%;font-size:10px;">
            ...
            <tr>
                <td><input class="roles" value="customer support full" type="checkbox" />&nbsp;Customer Support(Full)</td>
                <td><input class="roles" value="routing" type="checkbox" />&nbsp;Routing</td>    
            </tr>
            
            <tr>
                <td><input class="roles" value="advancing routing" type="checkbox"/>&nbsp;Routing (Advanced)</td>
                <td><input class="roles" value="advanced searching" type="checkbox"/>&nbsp;Searching (Advanced)</td>
            </tr>
            
            <tr>
                <td><input class="roles" value="report access" type="checkbox" />&nbsp;Reporting Access</td>
                <td><input class="roles" value="customer support advanced" type="checkbox" />&nbsp;Customer Support (Advanced)</td>
            </tr>
            
            <tr>
                <td><input class="roles" value="sales management" type="checkbox" />&nbsp;Sales Management</td>
                 <td><input class="roles" value="staff management" type="checkbox" />&nbsp;Staff Management</td>
            </tr>
            
            <tr>
                <td><input class="roles" value="user management" type="checkbox" />&nbsp;User Management</td>
                 <td><input class="roles" value="data management" type="checkbox" />&nbsp;Data Management</td>
            </tr>
            ...
            <tr>              
                <td><input class="roles" value="shop crew" type="checkbox" />&nbsp;Shop Crew</td>
