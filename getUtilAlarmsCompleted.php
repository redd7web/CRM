...
if(isset($_POST['search_now'])){
    ...
    switch($_POST['my_group']){
        ...
        case "account_rep":
            ...
            INNER JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE $utility_table.deleted =0 AND $utility_table.code_red =1 && $utility_table.route_status='completed' ".$string." group by account_rep $have";
        break;
        case "division":
            ...
            INNER JOIN $utility_table ON $utility_table.account_no = $account_table.account_ID 
            INNER JOIN $ikg_table ON $ikg_table.route_id = $utility_table.rout_no 
            INNER JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE $utility_table.deleted =0 AND $utility_table.code_red =1 && $utility_table.route_status='completed' ".$string." group by $account_table.division $have";
        break;
        case "driver":
            ...
            INNER JOIN $utility_table ON $utility_table.account_no = $account_table.account_ID 
            INNER JOIN $ikg_table ON $ikg_table.route_id = $utility_table.rout_no 
            INNER JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE $utility_table.deleted =0 AND $utility_table.code_red =1 && $utility_table.route_status='completed' ".$string." group by $ikg_table.driver $have";
        break;
        case "created_by":
            ...
            INNER JOIN $utility_table ON $utility_table.account_no = $account_table.account_ID 
            INNER JOIN $ikg_table ON $ikg_table.route_id = $utility_table.rout_no 
            INNER JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE  $utility_table.deleted =0 AND $utility_table.code_red =1 && $utility_table.route_status='completed' ".$string." group by $utility_table.created_by $have";
        break;
        default:
              $string = "SELECT 
            $utility_table.*,
            ...
            INNER JOIN $utility_table ON $utility_table.account_no = $account_table.account_ID 
            INNER JOIN $ikg_table ON $ikg_table.route_id = $utility_table.rout_no 
            INNER JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE  $utility_table.deleted =0 AND $utility_table.code_red =1 AND $utility_table.route_status='completed' ".$string." $have";
        break;
