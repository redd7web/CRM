...
<table style="width: 600px">
 ...
 <tr>
     <td style="text-align:right">Pick Up Day</td>
...
<tr><td style="text-align: right;vertical-align:top;"><input xlkr=""  type="submit" onclick="return false" value="Pickup Complete" id="pickup_complete"/></td><td style="text-align: center;vertical-align:top;"><img num="" account="" src="img/chat.jpg" class="mail2" style="cursor: pointer;width:50px;height:50px;"/></td></tr>
              ...
              $.get("retrieveSchedule_info.php",{sched_id:number,mode:"containment"},function(data){
                    ...
                    $.get("retrieveSchedule_info.php",{sched_id:number,mode:"amount"},function(data){
                        ...
                        $.get("retrieveSchedule_info.php",{sched_id:number,mode:"num"},function(data){
                         ...
                         $.get("addtextfield2.php",{sched_id:number,route_id:route},function(data){
                            //alert(data);
