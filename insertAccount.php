...
//    }
    ...
    $data = Array(
        ...
        "comp_name_id"=>$_POST['comp_name_id'],
		...
		"contract_group_id" =>$_POST['contract_group_id'],
...
if($_POST['sales_rep'] == 2065){
  ...
  */  
    /*
    if(isset($_POST['manager_bypass'])){
        mail("disen@iwpusa.com,AKramer@iwpusa.com,bthomas@iwpusa.com","Account created without contract $_POST[accountname]","Account $_POST[accountname] created by ".uNumToName($person->user_id),$headers);
    ...
    */
    ...
    if(isset($_POST['competitor_onsite_removal'])){
        ...
        //Assign issue to facility manager of new account
        ...
        mail("$managerEmail, bthomas@iwpusa.com","$competitor_container_message_subject","$competitor_container_message",$headers);
