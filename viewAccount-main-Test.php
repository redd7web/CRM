...
<div id="top-info-box-right" style="width: 490px;height:265px;background:none;float:left;">
    ...
    <div class="box" style="width: 50px;height:50px;float:left;margin-right:11px;margin-top:19px;background-size: contain;background:url(img/chat.jpg) no-repeat center top;" title="Create an Issue/Note">
    ...
    <div id="tracked" class="box" style="width: 50px;height:50px;float:left;margin-right:8px;background:url(img/track.jpg) no-repeat center top;margin-top:19px;background-size: contain;cursor:pointer" title="View Account Tracking History">
	...
	-->
    <div class="onsite" class="box" style="width: 50px;height:50px;float:left;background:rgba(255,255,255);margin-top:19px;margin-right:8px;cursor:pointer;">
        
        <img src="img/service.jpg" title="Schedule Container Delivery"/></a>
    </div>
	
	<!--
   <div id="GTsummary" class="box" style="width: 50px;height:50px;float:left;margin-right:8px;margin-top:19px;background:url(img/greasetrap_1_1.jpg) no-repeat center top;cursor:pointer;background-size: cover;" title="GT Summary">
   </div>
	-->
...
-->		
        ...
        <div id="d"  style="height: 100%;">
            <div style="width:100%;height:95%;overflow-y:auto;overflow-x:hidden;" id="fit" >
...
<div id="top-inf-box-short" style="height:25px;width:890px;float:left;background:rgb(255,255,255);padding:5px 5px 5px 5px;font-size:16px;word-spacing:1px;border:1px solid black;border-right:0px solid transparent;border-left:0px solid transparent;">

<span style="font-weight: bold;margin-left:10px;">Containment</span>&nbsp;<input type="submit" value=""  style="width: 20px;height:20px;background:transparent url(img/plus.png) no-repeat center center; background-size:contain;" class="onsite" title="Select then add container"/>&nbsp;Add Container
...
<!--        </div>-->
        ...
        <div id="uts" style="width: 409px;height:133px;overflow:auto;border:1px solid black;border-right:0px solid black;border-left:0px;border-bottom:0px;">
            <table style="width: 100%;">
                ...
                <?php
                $getc = $db->query("SELECT * FROM iwp_utility WHERE account_no = $account->acount_id AND route_status IN('enroute','scheduled')");
...
//                            $bg = '-moz-linear-gradient(center top , #F7F7F9, #E5E5E7) repeat scroll 0 0 rgba(0, 0, 0, 0)';
//                        }
//                        $op = $db->where("account_no",$account->acount_id)->where("route_id",$gtraps['grease_route_no'])->get("iwp_grease_data_table");
//
            ...
            <?php 
                ...
                if(count($getc)>0){
                    ...
                    foreach($getc as $utils){
                        ...
                        $hu = $db->query("SELECT date_of_pickup FROM iwp_utility_data_table WHERE account_no=$account->acount_id AND schedule_id=$utils[utility_sched_id] AND route_id=$utils[rout_no]");
