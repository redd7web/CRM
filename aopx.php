...
$check_how_much = $db->where("route_id",$_POST['route_id'])->get("iwp_list_of_routes","collected");
...
//$db->query("UPDATE iwp_list_of_routes SET collected = $collected WHERE route_id=$_POST[route_id] ");
//$db->query("UPDATE iwp_list_of_routes SET  inc  = inc-1 WHERE route_id=$_POST[route_id] AND inc >0 ");
