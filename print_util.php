...
<div class='content-wrapper' style='min-height:450px;height: auto;'>
    ...
    <tr>
        ...
        <td  style='padding: 0px 0px 0px 0px;'><div class='cell' style='border-top: 1px solid black;background:  -moz-linear-gradient(center top , #e7edf7, #adbef7) repeat scroll 0 0 rgba(0, 0, 0, 0);'>Service Type</div></td>
          ...
          <td  style='padding: 0px 0px 0px 0px;'><div class='cell' style='border-top: 1px solid black;background:  -moz-linear-gradient(center top , #e7edf7, #adbef7) repeat scroll 0 0 rgba(0, 0, 0, 0);'>Service</div></td>
...
$output = ob_get_clean();
                ...
                $html .="<td  style='border:1px solid black;'>".$acnt_info->singleField($g_stop->account_number,"notes")."</td>";          $html .="<td  style='border:1px solid black;'>"; 
                    switch($g_stop->service_type){
                        case 6:
                            $html .= "Site Cleanup";
                            break;
                        case 392:
                            $html .= "Verify Containment";
                            break;
                        case 3:
                            $html .= "Container Delivery";
                            break;
                        case 4:
                            $html .= "Container Retrieval";
                            break;
                        case 7:
                            $html .= "Lid Delivery";
                            break;
                        case 8:
                            $html .= "Wheels: Add/Modify";
                            break;
                        case 10:
                            $html .= "Lock: Add/Modify";
                            break;
                        case 24:
                            $html .= "Sensors: Add/Modify";
                            break;
                        case 100:
                            $html .= "Swap";
                            break;
                ...
                $html .="</td>"; 
                $html .= "<td style='border:1px solid black;'>".containerNumToName($g_stop->container_label);                
                if($g_stop->service_type == 100){
                    $html .=" swapped for : ".containerNumToName($g_stop->container_being_swapped_label);
                }
...
$new_string = "IKG_UTILITY_MANIFEST-$util_info->ikg_manifest_route_number".date("Ymd_his");
