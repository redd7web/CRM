   ...
   $('#myTable').dataTable({
        "lengthMenu": [ [10, 25, 50,100,150, -1], [10, 25, 50,100,150, "All"] ]
                            ...
                            if(isset($_POST['search_now'])){
                                ?>
                                <form method="POST">
                                <table style="width:200px;margin:auto;margin-top:20px;margin-bottom:20px;">
                                <tbody><tr><td class="field_label">
                                    Export Format
                                <input type="text" readonly="" name="query"/>
                                </td><td><select name="format"><option>XLS</option><option>CSV</option></select></td></tr></tbody></table></form>
                                <?Php
                            }
