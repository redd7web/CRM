...
<h1 style="width:100%;margin:auto;text-align:center;text-transform:uppercase;padding:0px 0px 0px 0px;">Service Issues</h1>
<p style="margin: auto;width:150px;">Create an Issue or Private Message</p>
...
<input type="text" " placeholder="subject" id="subject" name="subject" /><br /><br />
 ...
 <div class="quicksearch">
     <b>Select Account:</b> <input type="text" placeholder="Account ID or Name" id="quicks" class="quicks"  />
</div>
...
if(isset($_GET['account'])){
 ...
 ?> id="anumber"/>
<br /><br />
<b>Priority Level:</b> <select id="priority_id" name="priority_id">
