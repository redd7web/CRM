...
if($db->insert("Inetforms.ap_form_44342",$package)){
    ...
    if(count($kl)>0){
        if($kl[0]['element_16']==1){ 
            ...
            mail("IT@iwpusa.com","Cotton Report ".date("Y-m-d")."-$_GET[Req_ID]","Click here to review report <a href='https://inet.iwpusa.com/view_cotton_report.php?file=$file_name&entry_=$_GET[Req_ID]&report_type=".$kl[0]['element_16']."'>Click here to view report</a>",$headers); 
        }
    }
