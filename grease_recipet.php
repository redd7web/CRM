...
if(count($grease_ikg->scheduled_routes)>0){
        ...
        foreach($grease_ikg->scheduled_routes as $grease){
            ...
            $html .= '<table style="width:45%;height:95%;float:left;margin-left:3%;margin-top:0px;font-size:12px;" class="myTable">
                      <tr><td style="vertical-align:center;text-align:right;border:1px solid black;" colspan="2">'; 
                      ...
                      $html .='</td></tr>                      
                      <tr><td style="vertical-align:top;text-align:left;border:1px solid black;">Date</td><td style="vertical-align:top;text-align:left;border:1px solid black;">'.$grease_ikg->scheduled_date.'</td></tr>
                      ...
                      <tr><td colspan="2"  style="vertical-align:top;text-align:left;height:100px;border:1px solid black;">Comments: ';  
                      $html .="\r\n".$acc->singleField($g_stop->account_number,"notes");
                      $html .='</td></tr>
                      <tr><td colspan="2">
                      <img src="https://inet.iwpusa.com/img/grease_add.jpg"/>
                      </td></tr>
                      </table>';
                      
                                            
                       $html .= '<table style="width:45%;height:100%;float:left;margin-left:3%;margin-top:0px;font-size:12px;" class="myTable">
                      <tr><td style="vertical-align:center;text-align:right;border:1px solid black;" colspan="2">'; 
                        if($grease_ikg->recieving_facility_no ==15){
                            $html .="<img src='https://inet.iwpusa.com/img/cw3.jpeg'/>";
                        }else{
                            $html .="<img src='https://inet.iwpusa.com/img/biologo.jpg'/>";
                        }
