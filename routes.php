...
if(($handle = fopen($file,"r"))!==FALSE){
    ...
    while(($data = fgetcsv($handle,0,chr(9)))!==FALSE){
        ...
        $db->where("route_id",$data[0])->update("iwp_ikg_manifest_info",$route_package);
        ...
        $db->where("route_id",$data[0])->update("iwp_list_of_routes",$list_of_routes);
        ...
        $db->where("route_id",$data[0])->update("iwp_scheduled_routes",$sched_status);
    }
}
