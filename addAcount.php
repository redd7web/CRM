...
//    echo $select; ?>
    ...
    <div class="field">
        ...
        <select id="comp_name_id" name="comp_name_id" style="float: left;margin-left:5px;width:150px;">
            <option value="">--</option>
            <?php
            $competitors_request_onsite = $db->query("SELECT name, competitor_id from iwp_competitors WHERE active = 1 ORDER BY name ASC;");
            foreach ($competitors_request_onsite as $competitor){
...
<!--                <option value="Mahoney Environmental">Mahoney Environmental</option>-->
...
<!--                <option value="Tucson Tallow">Tucson Tallow</option>-->
<!--            </select>-->
    </div>

        <div class="field">
            <label for="competitor_onsite_removal">Comp Container On Site?</label>&nbsp;
        </div>
        <div class="field">
	...
	<div class="field">
        ...
        <div class="field">
            <select id="contract_group_id" name="contract_group_id" style="float: left;margin-left:5px;width:150px;">
                <option value="">--</option>
            <?php

                $contract_request = $db->query("SELECT entry_id, group_name FROM contract_groups WHERE active = 1 ORDER BY group_name ASC;");
                foreach ($contract_request as $contract_group){
                        echo "<option value='$contract_group[entry_id]'>$contract_group[group_name]</option>";
                }
            ?>
