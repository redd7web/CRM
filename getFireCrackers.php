...
<table  style="width: 100%;margin:auto;" id="myTable" >
    ...
    <tr style="background:url(img/biotanestrip.jpg) repeat-x left top;background-size:contain;">
        ...
        <td class="cell_label">Date Scheduled</a></td>
