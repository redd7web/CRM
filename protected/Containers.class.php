...
Class Container { 
   ...
   function updateRequestDate($value,$container){ 
        ...
        $db->where("container_no",$this->account_no)->where("container_no",$container)->update("iwp_containers",$data);
   }
   ...
   function updateDeliveryDate($value,$container){
        ...
        $db->where("account_no",$this->account_no)->where("container_no",$container)->update("iwp_containers",$data);
   }
