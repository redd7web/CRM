...
if(isset($_SESSION['id'])) {
    if (isset($_GET['route_id'])) {
        ...
        $request = $db->query("SELECT account_numbers, route_id, recieving_facility, facility_address,truck FROM iwp_ikg_manifest_info WHERE route_id = $_GET[route_id]");
...
//            ));
            ...
            if (!isset($responseOptimizedBody['output'])) {
                ...
                echo "Optmized Solution Took Too Long";
            } else {
                ...
                $sql = "UPDATE iwp_ikg_manifest SET account_numbers = '$account_numbers' WHERE route_id = $route_id";
                echo $sql;
            }
        }
    }
