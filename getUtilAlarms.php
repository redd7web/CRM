...
if(isset($_POST['search_now'])){
    ...
    switch($_POST['my_group']){
        ...
        case "account_rep":
            ...
            LEFT JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE $utility_table.deleted = 0 AND $utility_table.deleted = 0 AND $utility_table.code_red =1 && $utility_table.route_status  in ('enroute','scheduled') ".$string." group by account_rep $have";
        break;
        case "division":
            ...
            LEFT JOIN $utility_table ON $utility_table.account_no = $account_table.account_ID 
            LEFT JOIN $ikg_table ON $ikg_table.route_id = $utility_table.rout_no 
            LEFT JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE $utility_table.deleted = 0 AND $utility_table.code_red =1 && $utility_table.route_status  in ('enroute','scheduled')".$string." group by $account_table.division $have";
        break;
        case "driver":
            ...
            LEFT JOIN $utility_table ON $utility_table.account_no = $account_table.account_ID 
            LEFT JOIN $ikg_table ON $ikg_table.route_id = $utility_table.rout_no 
            LEFT JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE  $utility_table.deleted = 0 AND $utility_table.code_red =1 && $utility_table.route_status  in ('enroute','scheduled') ".$string." group by $ikg_table.driver $have";
        break;
        case "created_by":
            ...
            LEFT JOIN $utility_table ON $utility_table.account_no = $account_table.account_ID 
            LEFT JOIN $ikg_table ON $ikg_table.route_id = $utility_table.rout_no 
            LEFT JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE  $utility_table.deleted = 0 AND $utility_table.code_red =1 && $utility_table.route_status in ('enroute','scheduled') ".$string." group by $utility_table.created_by $have";
        break;
        default:
              $string = "SELECT 
            $utility_table.*,
            ...
            LEFT JOIN $utility_table ON $utility_table.account_no = $account_table.account_ID 
            LEFT JOIN $ikg_table ON $ikg_table.route_id = $utility_table.rout_no 
            LEFT JOIN $util_data ON $utility_table.utility_sched_id = $util_data.schedule_id WHERE  $utility_table.deleted = 0 AND $utility_table.code_red =1 AND $utility_table.route_status  in ('enroute','scheduled') ".$string." $have";
        break;
