...
if(isset($_POST['from_routed_oil_pickups'])){
    ...
    $result = $db->query("SELECT SUM(inches_to_gallons) *7.56 as x,SUM(inches_to_gallons) as pure FROM $data_table WHERE $data_table.deleted =0 AND route_id =$ikg_info->route_id");
    if(count($result)>0){
    ...
    array_pop($actns);
    array_pop($schnums);
    $acnts = array_unique($actns);
    $scheds = array_unique($schnums);    
} 
        ...
        <div id="info_hold" style="width: 1000px;margin:auto;height:100px;background:transparent;padding">
                <div id="leftsideboxes" style="float: left;width:600px;height:100px;">
                       <div class="leftsides" style="width:600px;height:100px;float:left;">
                        ...
                        <table><tr><td style="text-align: center;vertical-align:middle;width:275px;height:60px;" id="edata">
                        ...
                        <div class="box" style="width: 50px;height:60px;box-shadow: 2px 2px 5px #888888;float:left;text-align:center;cursor:pointer;" id="friendly">
                            <?php  if(isset($_POST['from_routed_oil_pickups'])){ ?>
                        ...
                        <div class="box" style="width: 50px;height:60px;box-shadow: 2px 2px 5px #888888;float:left;">
                        <?php 
                        if( isset($_POST['from_routed_oil_pickups']) ) {
                        ...
                        <div class="box" style="width: 50px;height:60px;box-shadow: 2px 2px 5px #888888;float:left;background-size:contain;text-align:center;" id="exp" xlr="<?php if(isset($_POST['from_routed_oil_pickups'])){
                        ...
                        <div class="box" style="width: 50px;height:60px;box-shadow: 2px 2px 5px #888888;float:left;background-size:contain;" id="pdfexp">
                       <?php  if(isset($_POST['from_routed_oil_pickups'])){ ?> <a href="downloadreceipt.php?route_no=<?php echo "$_POST[manifest]";  ?>" target="_blank"><img src="img/pdf.jpg"/></a> <?php } ?>
                        ...
                        <div class="box" style="width: 50px;height:60px;box-shadow: 2px 2px 5px #888888;float:left;background-size:contain;" id="print" >
                        <?php  if(isset($_POST['from_routed_oil_pickups'])){ ?> <a href="print_oil_ikg.php?ikg=<?php   echo $ikg_info->route_id;   ?>" target="_blank"><img src="img/print.jpg"/></a> <?php } ?>
                           ...
                           <div class="box" style="width: 50px;height:60px;box-shadow: 2px 2px 5px #888888;float:left;background:url(img/routific_logo.jpg) no-repeat center center;background-size:contain;cursor:pointer;" <?php if(isset($_POST['from_routed_oil_pickups']) ){ echo "title='routeific_reorder' id='routeific_reorder'";} else {?>  title="no_entry_in_db_yet"   id="no_entry_in_db_yet" <?php } ?>>
                        ...
                        <div class="box" style="width: 50px;height:60px;box-shadow: 2px 2px 5px #888888;float:left;background:url(img/createmod.jpg) no-repeat center center;background-size:contain;cursor:pointer;" <?php if(isset($_POST['from_routed_oil_pickups'])){ echo "title='Update' id='ikg_update'";} else {?>  title="Save"   id="ikg_create" <?php } ?>></div>
                        <div class="box" style="width: 50px;height:60px;box-shadow:2px 2px 5px #888888;float:left;backgroundsize:contain;" id="field_report">
                        ...
                        <div class="box" style="width: 50px;height:60px;box-shadow: 2px 2px 5px #888888;float:left;" title="Manual Reorder" id="manual_reorder" >
    ...
    <table style="width: 100%;font-size:10px;" id="meatikg">
        <tr>
            ...
            <?php
                ...
                if(isset($_POST['from_routed_grease_list'])){
                    echo getTrailers($ikg_info->trailer);     
                }else{
                    echo getTrailers("");
                }
        ...
        <tr>
            ...
            <?php 
                ...
                if(isset($_POST['from_routed_oil_pickups'])){
                     ...
                     echo "update:". $perc."<br/>";
                     if( $differ >= 500 ||   $perc> .10  || $ikg_info->ikg_gross_weight<50  || $perc < -10 || $differ > 0){
       ...
       <td>Gross Weight</td>
        ...
        <tr>
            ...
            <td>Weight Ticket Number</td><td><input name="weight_ticket_number" id="weight_ticket_number" value="<?php if(isset($_POST['from_routed_oil_pickups'])){ echo $ikg_info->weight_ticket_number;} ?>" /></td>
        </tr>
                 ...
                 foreach ($newlist_scheds as $ekc ){
                    ...
                    if($ekc != NULL){
                        ...
                        echo "<tr  id='row$sched_ro->schedule_id' style='cursor:pointer;background:$bg'  class='accnt_row' xlr='$sched_ro->account_number' rel='$ekc' title='$sched_ro->account_number'>
                            ...
                            echo "<td>$datee[0]</td>"; 
                            echo "<td>".$aaccoouunntt->formatted_Name($sched_ro->account_number)."</td>";
                            echo "<td>".$aaccoouunntt->singleField($sched_ro->account_number,"city")."</td>";
                            
                            
                            $address =trim($aaccoouunntt->singleField($sched_ro->account_number,"address"))."+".trim($aaccoouunntt->singleField($sched_ro->account_number,"city"))."+".trim($aaccoouunntt->singleField($sched_ro->account_number,"state"))."+".trim( $aaccoouunntt->singleField($sched_ro->account_number,"zip") )."+".trim($aaccoouunntt->singleField($sched_ro->account_number,"country"))." \r\n"; 
                            if(geocode($address) == 'OK'){                
                                echo "<td>".$aaccoouunntt->singleField($sched_ro->account_number,"address")."&nbsp;<img src='img/check_green_2s.png' style='width:10px;height:10px;'/><br/></td>";                                 
                            }else{
                                echo "<td><span style='cursor:pointer;text-decoration:underline;color:blue;' rel='$sched_ro->account_number' class='fix_address' title='Click on Address to verify and/or fix'>".$aaccoouunntt->singleField($sched_ro->account_number,"address")."&nbsp;</span>";
                            }
                            
                            
                            
                            echo "<td class='notes' rel='".$aaccoouunntt->singleField($sched_ro->account_number,"notes")."'>".$aaccoouunntt->singleField($sched_ro->account_number,"notes")."</td>";
                            echo "<td>".$sched_ro->onsite."</td>
                            ...
                            echo "<td>";//net mileage
                                    echo date_different($first[0],$sched_ro->scheduled_start_date) * $aaccoouunntt->singleField($sched_ro->account_number,"ticks_per_day");
                            echo "</td>
                        </tr>";
                        $count++;                        
                    }
...
function close_window() {
 ...
 var k =    $("#gross_weight").val() - $("#tara_weight").val() ;
            ...
            if( percentage >.1 || $("#diference").val() >=500  || $("#gross_weight").val() <50  || percentage < -10 || $("#diference").val() > 0){
...
$("#routeific_reorder").click(function(){
...
//Brandon Changes //
    ...
    $("#ikg_update").click(function(){
        ...
        $.post('ikg_update.php',{
            ...
            weight_ticket_number:$("input#weight_ticket_number").val()
        },function(data){
            alert(data);
            $("#debug").html(data);
