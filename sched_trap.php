...
$check_grease_ = $db->query("SELECT * FROM iwp_grease_traps WHERE account_no = $account->acount_id AND route_status !='completed' ORDER BY date DESC");
?>
                     ...
                     <table style="width: 100%;border:1px solid #bbb;">
                       ...
                       <tr class="table_row">
                        ...
                        <tr><td>Add to Existing</td><td style="text-align: left;"><input type="radio" value="3" name="sched_type" class="sched_type"/>
                            <?php 
                            $ko = $db->query("SELECT ikg_manifest_route_number,route_id,driver FROM iwp_list_of_grease WHERE status='enroute' ORDER BY created_date DESC");
