...
<table style="width: 100%;margin:auto;" >
  <tr><th colspan="3" style="height: 20px;"><a href="../addUser.php" target="_blank"><img src="img/add_item.big.gif" />&nbsp;<span style="font-size: 12px;">Add User</span><br /></th></tr>
</table>
...
<thead>
  ...
  <tr style="background:url(img/biotanestrip.jpg) repeat-x left top;background-size:contain;">
      ...
      <th style="padding:0px 0px 0px 0px;" class="cell_label"><span style="font-size:9px;" title="User can enter data: new accounts, collection/trip reports">Data Entry</span></th>
                    ...
                    <th class="cell_label">Approved</th>
                 </tr>
                 </thead>
                 <tbody>
                    ...
                    foreach($result as $user){
                        ...
                        echo "<tr style='background:$bg;'>
                            ...
                            <td><span style='font-size:12px;'>"; 
                                if($logger->isAdmin()){
                                    echo "<span class='chngpw' style='cursor:pointer;text-decoration:underline;color:blue;font-weight:bold;' rel='$person->user_id' title='Click Here to Reset Password'>$person->user_id</span>";
                                }else{
                                    echo "$person->user_id";
                                }
                            echo "</span></td>
                            ...
                            <td>"; 
                                if($person->approved ==1){
                                    ...
                                    if($logger->user_id ==185 || $logger->user_id  == 99){
                                        echo "<span class='approve' style='cursor:poiner;text-decoration:underline;' rel='$person->user_id'>No</span>";
                                    }else{
                                        echo "No";
                                    }
                                }
