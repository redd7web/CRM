    ...
    foreach($_POST as $name=>$value){
        switch($name){
            ...
            case "facility";
                    if($value !="ignore"){
                        if ($value == 99){
                             $arrField[] = "iwp_accounts.division in(24,30,31,32,33)";
                        }
                        else{
...
<?php 
    ...
    <input type="hidden"  name="params" value="<?php if( isset($_POST['search_now']) ){ echo $criteria1;  }   ?>"/>
    </form></td></tr>
        <?php
    }
?>
        <tr><td colspan="3" style="text-align: center;color:red;">Please perform your search before exporting.</td></tr>
...
<th class="cell_label">Account ID</th>
