...
if( count($ikg_info->scheduled_routes)>0){
    ...
    foreach($buffer as $sched_num){
        ...
        $html .='<table style="width:45%;height:100%;float:left;margin-left:3%;" class="myTable">
              <tr><td style="vertical-align:center;text-align:center;border:1px solid black;"><p>Call today for grease trap service<br/>877.424.6826</p></td><td style="vertical-align:center;text-align:right;border:1px solid black;"><img src="https://inet.iwpusa.com/img/blogo.jpg"/><p><span style="font-size:8px">A Company of Imperial Western Products, Inc</span></p></td></tr>
